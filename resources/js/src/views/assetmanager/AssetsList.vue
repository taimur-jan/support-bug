      ...
      >
          ...
          <b-media vertical-align="center">
            <template #aside>
              <b-avatar
                ...
                :variant="`light-${resolveAssetRoleVariant(data.item.role)}`"
                :to="{ name: 'assets-list', params: { id: data.item.id } }"
              />
            </template>
            <b-link
              :to="{ name: 'assets-list', params: { id: data.item.id } }"
            ...
            <small class="text-muted">@{{ data.item.assetname }}</small>
          </b-media>
        </template>
        ...
        <template #cell(role)="data">
          <div class="text-nowrap">
            <feather-icon
              :icon="resolveAssetRoleIcon(data.item.role)"
              size="18"
              class="mr-50"
              :class="`text-${resolveAssetRoleVariant(data.item.role)}`"
            />
        ...
        <template #cell(status)="data">
          <b-badge
            pill
            :variant="`light-${resolveAssetStatusVariant(data.item.status)}`"
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item :to="{ name: 'assets-list', params: { id: data.item.id } }">
...
import AssetsListFilters from './AssetsListFilters.vue'
