        ...
        >
          ...
          >
            <b-form-checkbox-group
              id="contact-options"
              v-model="caseDataInfo.contactOptions"
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <b-form-input
              id="address-line-1"
              v-model="caseDataInfo.addressLine1"
            />
          </b-form-group>
        </b-col>
        ...
        >
          ...
          >
            <b-form-input
              id="address-line-2"
              v-model="caseDataInfo.addressLine2"
